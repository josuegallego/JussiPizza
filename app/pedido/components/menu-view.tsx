  ...
  const menuCategories = [
    {
      ...
      items: [
        // Traditional flavors
        {
          ...
          type: "traditional",
          sizes: ["Porción ($9.000)", "Personal (21cm $18.000)", "Pequeña (6 porciones $32.000)", "Mediana (8-10 porciones $42.000)"],
        },
        {
          name: "Jamón y Queso",
        ...
        // Special flavors
        {
          ...
          type: "special",
          sizes: ["Personal (21cm $22.000)", "Pequeña (6 porciones $37.000)", "Mediana (8-10 porciones $46.000)"],
        },
        {
          name: "Especial",
