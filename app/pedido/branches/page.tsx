    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-brown-900 mb-2">📍 Visítanos</h2>
          <p className="text-brown-700 text-lg">Encuentra la sede más cercana a ti</p>
        </div>
          ...
          {branches.map((branch, index) => (
            <Card key={index} className="border-2 border-green-200 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="p-0">
                {/* Google Maps Embed */}
                <div className="w-full h-64 bg-gray-200 rounded-none">
                  <iframe
                    src={branch.mapEmbed}
                    width="100%"
                    height="100%"
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-brown-900">Dirección</p>
                      <p className="text-brown-700">{branch.address}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-brown-900">Horarios</p>
                      <p className="text-brown-700">Miércoles a Lunes</p>
                      <p className="text-brown-700">6:00 PM - 10:30 PM</p>
                    </div>
                  </div>
        ...
        <Card className="mt-8 border-2 border-orange-200 bg-orange-50">
          <CardContent className="p-6 text-center">
            <h3 className="text-xl font-bold text-brown-900 mb-4">🍕 Información General</h3>
            <div className="grid md:grid-cols-2 gap-4 text-left">
              ...
              <div>
                ...
                <p className="text-brown-700">Disponible en toda Jamundí</p>
                <p className="text-brown-700">Tiempo estimado: 30-45 minutos</p>
              </div>
            </div>
            <div className="mt-6">
              <Button
