...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-[100svh] bg-gradient-to-br from-amber-50 to-orange-50 overflow-hidden">
      {/* Fondos decorativos - siempre detrás */}
      <div className="absolute -top-20 -left-20 w-72 h-72 bg-orange-200 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-pulse z-0"></div>
